...
import com.hhx.pureNews.util.ITHomeUtils;
...
public class ItArticleActivity extends AppCompatActivity implements ItArticleContract.View {
    ...
    private void initweb() {
        ...
        webview.addJavascriptInterface(new ItJsInterface(), "itArticleActivity");
    ...
    public void loadSucess(IthomeContentItem ithomeContentItem) {
        mData = WebUtil.buildHtmlForIt(ithomeContentItem.getDetail(), false);
    ...
    public void onViewClicked() {
        ...
        mShare = "http://www.ithome.com" + getIntent().getStringExtra("share");
