...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public ArrayList<ChannelEntity> mMyChannelItems, mOtherChannelItems;
    ...
    private void cancelEditMode(RecyclerView parent) {
        ...
        mCompleteListener.onComplete(mMyChannelItems, mOtherChannelItems);
    }
    ...
    public interface OnCompleteListener {
        void onComplete(ArrayList<ChannelEntity> myChannelItems, ArrayList<ChannelEntity> otherChannelItems);
    }
}
