package com.hhx.pureNews.modules.wangyinews;
...
import com.hhx.pureNews.modules.wangyinews.mvp.WangyiArticleActivity;
import com.hhx.pureNews.modules.wangyinews.mvp.WangyiNews;
import com.hhx.pureNews.modules.wangyinews.mvp.WangyiPhotoActivity;
        ...
        switch (helper.getItemViewType()) {
            ...
            case WangyiNews.Bean.ITEM:
                GlideApp.with(mContext)
                        .load(item.getImgsrc()).centerCrop().into((ImageView) helper.getView(R.id.card_news_item_iv));
